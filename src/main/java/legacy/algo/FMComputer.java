...
public class FMComputer {
    public int level;
    private Bipartition8Values initialBipartition_8_values;
    ...
    private Map<Integer, Bipartition8Values> mapCandidateTax_vs_8vals; //after hypothetical swap [i.e. IF this is taken as snapshot, no need to recalculate]
    ...
    public FMComputer(CustomDSPerLevel customDS,
                      ...
                      Bipartition8Values initialBip_8_vals, int level) {
    ...
    public void run_FM_singlepass_hypothetical_swap() {//per pass or step [per num taxa of steps].
        ...
        for (int taxToConsider : this.customDS.taxa_list_int) {
            ...
            Bipartition8Values _8_vals_THIS_TAX_before_hypo_swap = new Bipartition8Values(); // all initialized to 0
            Bipartition8Values _8_vals_THIS_TAX_after_hypo_swap = new Bipartition8Values(); // all initialized to 0
            ...
            Bipartition8Values _8_values_whole_considering_thisTax_swap = new Bipartition8Values();
    ...
    public void changeParameterValuesForNextPass() {
        ...
        this.initialBipartition_8_values = new Bipartition8Values(previousPassStats._8_values_chosen_for_this_pass);
...
//                StatsPerPass last_pass_stat = this.listOfPerPassStatistics.get(this.listOfPerPassStatistics.size() - 1);
            ...
            areAllTaxaLocked = IOHandler.checkAllValuesIFSame(this.lockedTaxaBooleanMap, true); //if ALL are true, then stop.
        }
    ...
    public boolean changeAndCheckAfterFMSingleIteration() {
        ...
        if (max_cumulative_gain_of_current_iteration > Config.SMALLEPSILON) {
            ...
            if ((this.isFirstTime == false) && (max_cumulative_gain_of_current_iteration == this.prevCumulativeMax)) {
                ...
                if (IOHandler.areEqualBipartition(statOfMaxCumulativeGainBox.map_final_bipartition,
                        this.prevMap,
                        DefaultValues.LEFT_PARTITION,
                        DefaultValues.RIGHT_PARTITION,
