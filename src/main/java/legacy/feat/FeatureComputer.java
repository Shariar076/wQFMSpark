...
public class FeatureComputer {
    private static List<Integer> sortTaxaWithinQuartets(int tax1, int tax2, int tax3, int tax4) {
//        int[] arr = {tax1, tax2, tax3, tax4};
    ...
    public static void computeBinningFeatureUsingLevel1(Map<List<Integer>, List<Double>> dictionary_4Tax_sequence_weight, int level) {
        if (level > 1) {
//            System.out.println("Bin only level 1, current level = " + level + " , not binning, beta = " + WeightedPartitionScores.BETA_PARTITION_SCORE);
    ...
    public static void computeBinningFeatureUsingAllLevels(Map<List<Integer>, List<Double>> dictionary_4Tax_sequence_weight, int level) {
