...
public class wQFMRun {
    ...
    public static String runwQFM(String inputFilename, String outputFileName) {
        ...
        wQFMRun.testIfRerootWorks(); // test to check if phylonet jar is attached correctly.
    ...
    public static void minimalCall() {
        ...
        String treeOutput = wQFMRun.runwQFM(Config.INPUT_FILE_NAME, Config.OUTPUT_FILE_NAME); // run wQFM
    }
