...
public class WeightedPartitionScores {
    ...
    private static double calculatePScore0(Bipartition8Values bip_8_vals) {
        return (bip_8_vals.wtSatisfied - bip_8_vals.wtViolated);
    }

    private static double calculatePScore1(Bipartition8Values bip_8_vals) {
        return (bip_8_vals.wtSatisfied - 0.5 * bip_8_vals.wtViolated);
    }

    private static double calculatePScore2(Bipartition8Values bip_8_vals) {
        return (bip_8_vals.wtSatisfied - bip_8_vals.wtViolated - bip_8_vals.wtDeferred);
    }

    private static double calculatePScore3(Bipartition8Values bip_8_vals) {
        return (3 * bip_8_vals.wtSatisfied - 2 * bip_8_vals.wtViolated);
    }

    private static double calculatePScore4(Bipartition8Values bip_8_vals) {
        return (5 * bip_8_vals.wtSatisfied - 4 * bip_8_vals.wtViolated);
    }

    private static double calculatePScore5(Bipartition8Values bip_8_vals) {
        return bip_8_vals.wtSatisfied;
    }

    private static double calculatePScore6(Bipartition8Values bip_8_vals) {
        return (bip_8_vals.wtSatisfied - 0.5 * bip_8_vals.wtViolated - 0.25 * bip_8_vals.wtDeferred);
    }

    private static double calculatePScore7(Bipartition8Values bip_8_vals) {
        return (11 * bip_8_vals.wtSatisfied - 1 * bip_8_vals.wtViolated);
    }

    private static double calculatePScoreCommandLine(Bipartition8Values bip_8_vals) {
    ...
    private static double calculatePScoreFullDynamic(Bipartition8Values bip_8_vals) {
        return (WeightedPartitionScores.ALPHA_PARTITION_SCORE * bip_8_vals.wtSatisfied - WeightedPartitionScores.BETA_PARTITION_SCORE * bip_8_vals.wtViolated);
    }

    public static double calculatePartitionScoreReduced(Bipartition8Values bip_8_vals) {
