...
public class ConfigValues {
    public static final String INPUT_FILE_NAME = "input/gtree_15tax_100g_100b_R1.tre"; //DefaultConfigs.INPUT_FILE_NAME_WQRTS_DEFAULT; // "input_files/weighted_quartets_avian_biological_dataset";
