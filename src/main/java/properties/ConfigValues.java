...
public class ConfigValues {
    ...
    public static String INPUT_FILE_NAME = "input/101_taxa_01.true.wqrts"; //"input/101_taxa_01.true.wqrts";
    public static String OUTPUT_FILE_NAME = "output/output-gt.tree";
    public static String REFERENCE_FILE_NAME = "input/101_tax_ref.tre";
    public static int TAXA_PER_PARTITION = 50;
